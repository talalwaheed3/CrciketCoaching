  ...
  const handleSignIn = async () => {
    if (username && password) {
      ...
      if (data.result == "Login Successful") {
        ...
        if (role === "Manager") navigate("/managerDashboard", {state: data.user});
        if (role === "coach" || role === "Coach") navigate("/coachDashboard", {state: data.user});
        if (role === "player" || role === "Player") navigate("/playerDashboard", {state: data.user});
