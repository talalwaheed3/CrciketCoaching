...
model = YOLO('yolov8x.pt')  # You can choose a different YOLOv8 model (e.g., yolov8s.pt, yolov8m.pt)
...
# Example usage
image_path = r"D:\BIIT\CrciketCoahing\images\Coverdrive\coverdrive-18.jpg"  # Replace with your input image path
