...
def process_best_frame(img):
    ...
    cv2.imshow("best_frame", frame)
    cv2.waitKey(0)
    print(bat_center)
    all_angles = angles.processing_image_using_mediapipe(frame, bat_center)
    return all_angles


image = cv2.imread(r"C:\Users\Hp EliteBook 840 G5\OneDrive\Pictures\Screenshots\leg glance GT.png")
all_angles, img = process_best_frame(image)
